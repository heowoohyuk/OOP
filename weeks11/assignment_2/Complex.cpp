...
Number *Complex::add(Number * num) {
 ...
 if (num->types() == INTEGER) {
	   ...
	   this->set_val(other->val() + this->real(),this->imag());
	   delete(other);
	   return this;
...
Number *Complex::sub(Number * num) {
 ...
 Complex * other = dynamic_cast<Complex*>(num);
	   other->set_val(this->real()-other->real(),this->imag()-other->imag());
	   delete(this);
	   return other;
...
Number *Complex::mul(Number * num) {
 ...
 Complex * other = dynamic_cast<Complex*>(num);
	   other->set_val((other->real() * this->real())-(other->imag()*this->imag()),this->real()*other->imag()+this->imag()*other->real());
	   delete(this);
	   return other;
