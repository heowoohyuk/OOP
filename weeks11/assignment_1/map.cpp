...
int main() {
    ...
    // "third": 30
    // "fourth": 40
    m.insert(std::pair<std::string, int>("first", 10));
    m.insert(std::pair<std::string, int>("second", 20));
    m.insert(std::pair<std::string, int>("third", 30));
    m.insert(std::pair<std::string, int>("fourth", 40));
